...
from recomendacoes import recomendar_jogos
    ...
    while True:
        try:
            ...
            if op == "1":
                ...
                print(f"OK {len(lista_jogos)} jogos carregados!")
                
                backlog = filabacklog()
                print("\nPopulando backlog...")
                for jogo in lista_jogos:
                    backlog.enqueue(jogo)
                print(f"OK Backlog pronto com {backlog.tamanho()} jogos!\n")

            elif op == "2":
                if not lista_jogos:
                    print("ERRO Catálogo não carregado!")
                else:
                ...
                if not lista_jogos:
                    ...
                    if filtrados:
                        ...
                        print(f"ERRO Nenhum jogo encontrado no gênero '{genero}'.")
                ...
                if not lista_jogos:
                    ...
                    if filtrados:
                        ...
                        print(f"ERRO Nenhum jogo encontrado para '{console}'.")
                ...
                if not lista_jogos:
                    ...
                    try:
                        ...
                        if filtrados:
                            ...
                            print(f"ERRO Nenhum jogo encontrado com nota >= {nota_min}.")
                    except ValueError:
                ...
                if not lista_jogos:
                    ...
                    print("OK Catálogo ordenado por título!")
                ...
                if not lista_jogos:
                    ...
                    if jogo:
                        if not backlog.contem(jogo.id_jogo):
                            ...
                            print("ERRO Jogo já está no backlog!")
                    else:
                ...
                if not lista_jogos:
                    ...
                    if jogo:
                        ...
                        print("ERRO Backlog vazio! Não há jogos para jogar.")
                ...
                if not lista_jogos:
                    ...
                    print("ERRO Nenhum jogo recente!")
                else:
                    jogo = recentes.topo()
                ...
                if not lista_jogos:
                    ...
                    print("ERRO Nenhum jogo recente para registrar!")
                else:
                    jogo = recentes.topo()
                    try:
                        tempo = float(input("Tempo jogado: "))
                ...
                if not lista_jogos:
                    ...
                    print("OK Backlog salvo em 'backlog.txt'!")
